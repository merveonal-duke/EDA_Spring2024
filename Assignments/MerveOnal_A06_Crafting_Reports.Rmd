...
```{r task4.1, echo=F, fig.align='left', fig.cap='Monthly Ozone, 2018', out.height="40%", message=FALSE, warning=FALSE}
...
```{r task4.2, echo=F, fig.align='left', fig.cap='Monthly Ozone, 2019', out.height="40%", warning=FALSE}
...
## Git Repository 
https://github.com/merveonal-duke/EDA_Spring2024/tree/main/Assignments
